...
{
    /**
     * Current window that contains buttons
     */
    ...
    /**
     * Level Creation Button
     */
    private Button levelCreatorButton = new Button("Level Creator");

    /**
     * No args constructor, initializes buttons on the window.
     * Links action listeners to activate buttons.
     */
    public MenuWindow() 
    {
    ...
    /**
     * free play listener for the free play button
     */
    ...
    private class LSListener implements ActionListener 
    {
        ...
        /**
         * Makes a popup prompting level select.
         * Checks to see if valid input has entered to enter a level 1-4
         * @return True if user presses cancel or enters good input in which case a mowergame is created
         * False otherwise
         */
    ...
    private class LCListener implements ActionListener 
    {
        ...
        /**
         * creates a popup asking for parameters for a custom level.
         * Checks to see if valid level creator input has been entered with try-catch statements.
         * If valid input is entered, a new LawnMap is created and it is used to make a new level.
         * @return True if valid input is entered or user presses cancel, False otherwise
         * 
         */
        private boolean checked() 
        {
